                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example" data-sortable>
                            ...
                            @foreach($deals as $key => $deal)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-right">
                                         <a class="btn btn-success" href="{{ URL::to('deals/view/' . $value->id) }}" ><i class="fa fa-eye" aria-hidden="true"></i></a>
                                         <a class="btn btn-warning" href="{{ URL::to('deals/form/update/' . $value->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            @endforeach
